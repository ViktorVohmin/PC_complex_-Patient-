...
-- Started on 2023-09-25 10:25:30
...
-- Completed on 2023-09-25 10:25:32
...
-- Started on 2023-09-25 10:25:32
...
--
-- TOC entry 210 (class 1259 OID 24617)
-- Name: registry_staff; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.registry_staff (
    id integer NOT NULL,
    fname character varying(50),
    sname character varying(50),
    lname character varying(50)
...
ALTER TABLE public.registry_staff OWNER TO postgres;

--
-- TOC entry 209 (class 1259 OID 24615)
-- Name: registry_staff_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.registry_staff_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.registry_staff_id_seq OWNER TO postgres;

--
-- TOC entry 2883 (class 0 OID 0)
-- Dependencies: 209
-- Name: registry_staff_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.registry_staff_id_seq OWNED BY public.registry_staff.id;
...
--
-- TOC entry 2716 (class 2604 OID 24591)
...
--
-- TOC entry 2718 (class 2604 OID 24612)
...
--
-- TOC entry 2717 (class 2604 OID 24599)
...
--
-- TOC entry 2719 (class 2604 OID 24620)
-- Name: registry_staff id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_staff ALTER COLUMN id SET DEFAULT nextval('public.registry_staff_id_seq'::regclass);


--
-- TOC entry 2865 (class 0 OID 24588)
-- Dependencies: 204
...
--
-- TOC entry 2873 (class 0 OID 24625)
-- Dependencies: 212
...
--
-- TOC entry 2869 (class 0 OID 24609)
-- Dependencies: 208
...
--
-- TOC entry 2867 (class 0 OID 24596)
-- Dependencies: 206
...
--
-- TOC entry 2871 (class 0 OID 24617)
-- Dependencies: 210
-- Data for Name: registry_staff; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.registry_staff (id, fname, sname, lname) FROM stdin;
\.
...
-- Dependencies: 209
-- Name: registry_staff_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.registry_staff_id_seq', 1, false);
...
--
-- TOC entry 2723 (class 2606 OID 24593)
...
--
-- TOC entry 2731 (class 2606 OID 24634)
...
--
-- TOC entry 2725 (class 2606 OID 24601)
...
--
-- TOC entry 2729 (class 2606 OID 24622)
-- Name: registry_staff registry_staff_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registry_staff
    ADD CONSTRAINT registry_staff_pkey PRIMARY KEY (id);


--
-- TOC entry 2727 (class 2606 OID 24614)
...
--
-- TOC entry 2734 (class 2606 OID 24640)
...
--
-- TOC entry 2733 (class 2606 OID 24635)
...
--
-- TOC entry 2735 (class 2606 OID 24645)
-- Name: appointments appointments_staff_registration_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_staff_registration_id_fkey FOREIGN KEY (staff_registration_id) REFERENCES public.registry_staff(id);


--
-- TOC entry 2732 (class 2606 OID 24602)
...
-- Completed on 2023-09-25 10:25:33
